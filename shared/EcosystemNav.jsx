  ...
  const handleGoogleSignIn = async () => {
    ...
    if (res.success) {
      ...
      if (showActivateModal) {
        setActivateError(res.error || "Google Sign-In failed.");
      }
    }
  };
            ...
            {activateSuccess ? (
              ...
              <div>
                ...
                >
                  ...
                  {isGoogleSigningIn ? "Signing in with Google..." : "1-Click Activate with Google"}
                </button>

                <div style={{ display: "flex", alignItems: "center", margin: "14px 0 18px", gap: "10px" }}>
                  <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.1)" }} />
                  <span style={{ fontSize: "0.72rem", color: "#64748b", textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.05em" }}>OR MANUALLY ENTER CODE</span>
                  <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.1)" }} />
                </div>
          ...
          <div style={{
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <div style={{ display: "flex", alignItems: "center", margin: "14px 0", gap: "10px" }}>
                <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.1)" }} />
                <span style={{ fontSize: "0.72rem", color: "#64748b", textTransform: "uppercase", fontWeight: 700, letterSpacing: "0.05em" }}>OR</span>
                <div style={{ flex: 1, height: "1px", background: "rgba(255,255,255,0.1)" }} />
              </div>
